...
//        int blockSize = FileCipher.algorithmBlockSize(algorithm);
        ...
        for (int i = 0; i< plainTextBytes.length; i += blockSize){
            ...
            System.arraycopy(FileCipher.xorla(ecb.encrypt(tempIV,secretKey,algorithm),temp,algorithm),0,cipherText,i,blockSize);
...
//        int blockSize = FileCipher.algorithmBlockSize(algorithm);
        ...
        for (int i = 0; i< plainText.length; i += blockSize){
            ...
            System.arraycopy(FileCipher.xorla(ecb.encrypt(tempIV,secretKey,algorithm),temp,algorithm),0,plainText,i,blockSize);
            tempIV = ecb.encrypt(tempIV,secretKey,algorithm);
